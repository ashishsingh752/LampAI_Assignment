...
const AssessmentCard = ({ title, image, bgColor }) => (
  <div className={`w-56 rounded-lg shadow-lg overflow-hidden ${bgColor}`}>
...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className={`pt-20 transition-all duration-300 ${isSidebarOpen ? 'pl-64' : 'pl-24'}`}>
        <div className="p-6">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center space-x-4">
            <div className="space-x-4 overflow-x-scroll">
